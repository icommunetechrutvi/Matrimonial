...
//key all ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  void _bottomSheetClosed(dynamic responseData) {
                              ...
                              child: CheckboxListTile(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    print(
                                        "_selectedEducation${_education[firstIndex].id}");
                                  });
                                },
                                title: Text(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      ...
                                      _selectedEducation[secondIndex] =
                                          value ?? false;
                                      educationKey =
                                          _education[secondIndex].id.toString();
                                      print(
                                          "_selectedEducation${_education[secondIndex].id}");
                                    });
                                  },
                                  title: Text(
                              ...
                              child: CheckboxListTile(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    /*  _selectedMaritalStatus[index * 2 + 1] =
                                        value!;
                                    for (int i = 0; i < _selectedMaritalStatus.length; i++) {
                                      if (value) {
                                        // selectedMaritalKey =
                                        //     _maritalList.keys.elementAt(
                                        //         index * 2 + 1);
                                        selectedMaritalKey.add(_maritalList.keys.elementAt(i));
                                        selectedMaritalKey.join(",");
                                        print("selectedMaritalKey$selectedMaritalKey");
                                      }
                                    }*/
                                    setState(() {
                                      _selectedMaritalStatus[index * 2 + 1] =
